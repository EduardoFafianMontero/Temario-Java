...
introduccion/	✅ Completado	Estructura básica de una clase Java, main, System.out.println()
Variables/	🔄 En progreso	Declaración, tipos de datos y uso de variables
Tipos de datos/	🔄 En progreso	Tipos primitivos (byte, short, int, long, float, double, char, boolean) y tipos de referencia (String)
